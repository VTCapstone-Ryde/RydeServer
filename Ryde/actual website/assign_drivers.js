...
/*From: http://www.bootply.com/lz92105/UFLBWTTXAR# */
angular
.module('lvl.services',[])
...
var userData = [
  {id:1,firstName:'Mary',lastName:'Goodman',role:'driver',approved:true,points:34},
  {id:2,firstName:'Mark',lastName:'Wilson',role:'driver',approved:true,points:4},
  {id:3,firstName:'Alex',lastName:'Davies',role:'driver',approved:true,points:56},
  {id:4,firstName:'Bob',lastName:'Banks',role:'driver',approved:false,points:14},
  {id:5,firstName:'David',lastName:'Stevens',role:'driver',approved:false,points:100},
  {id:6,firstName:'Jason',lastName:'Durham',role:'driver',approved:false,points:0},
  {id:7,firstName:'Jeff',lastName:'Marks',role:'driver',approved:true,points:8},
  {id:8,firstName:'Betty',lastName:'Abercrombie',role:'driver',approved:true,points:18},
  {id:9,firstName:'Krista',lastName:'Michaelson',role:'driver',approved:true,points:10},
  {id:11,firstName:'Devin',lastName:'Sumner',role:'driver',approved:false,points:3},
  {id:12,firstName:'Navid',lastName:'Palit',role:'driver',approved:true,points:57},
  {id:13,firstName:'Bhat',lastName:'Phuart',role:'driver',approved:false,points:314},
  {id:14,firstName:'Nuper',lastName:'Galzona',role:'driver',approved:true,points:94}
];
